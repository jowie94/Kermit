...
namespace Kermit.Parser
{
    ...
    internal static class ThrowHelper
    {
        ...
        internal static ParserException AlreadyDefinedArg(string source, int line, int position, string input, string varname, Exception inner)
        {
            string msg = "Argument " + varname + " already defined";
            return SyntaxError(source, line, position, input, msg, inner);
        }
        ...
        internal static ParserException SyntaxError(string source, int line, int position, string input, string message,
            Exception inner)
        {
            return new ParserException(source, line, position, input, "SyntaxError: " + message, inner);
        }
    }
}
